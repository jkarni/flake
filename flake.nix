{
  ...
  outputs =
    ...
    in
    {
      ...
      packages."x86_64-linux"."snell" = import ./pkgs/snell { inherit (nixpkgs.legacyPackages."x86_64-linux") stdenvNoCC unzip fetchurl; };
      packages."aarch64-darwin"."snell" = import ./pkgs/snell { inherit (nixpkgs.legacyPackages."aarch64-darwin") stdenvNoCC unzip fetchurl; }; 
      #############################################################################################################################
      # Shell
